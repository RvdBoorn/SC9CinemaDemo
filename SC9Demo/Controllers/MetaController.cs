...
{
    public class MetaController : Sitecore9BaseController
    {
        ...
        public string PromoCssTheme()
        {
            Item pres = SiteConfiguration.GetPresentationSettingsItem();
            if (pres != null)
                return String.Format("<link rel=\"stylesheet\" href=\"/assets/promo/css/colors/skin-{0}.css\" id=\"skin-\" />", pres.Fields["Site Color"].Value.ToLower());
            return null;
        }
