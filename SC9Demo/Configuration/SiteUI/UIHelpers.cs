...
namespace SC9Demo.Configuration.SiteUI
{
    public static class UIHelpers
    {
        ...
        public static string GetRandomAlphaNumeric(int num)
        {
            Random random = new Random();
            var chars = "abcdefghijklmnopqrstuvwxyz";
            return new string(chars.Select(c => chars[random.Next(chars.Length)]).Take(num).ToArray());
        }
