...
using SC9Demo.Configuration.SiteUI.Search.Helper;
using SC9Demo.Configuration.SiteUI.Search.Models;
...
namespace SC9Demo.Configuration.SiteUI.Base
{
    public class Sitecore9BaseController : Controller
    {
