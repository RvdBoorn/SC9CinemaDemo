...
using SC9Demo.Configuration.SiteUI.Search;
...
namespace SC9Demo.Configuration
{
    public static class SiteConfiguration
    {
        ...
        public static Item GetSitesFolder()
        {
            return Sitecore.Context.Database.GetItem("/sitecore/content/sites");
        }
        ...
        public static Item GetHomeItem()
        {
            ...
            {
                if (temp.Parent.TemplateID == new ID("{D11C27EE-53FD-443B-AD91-965171E44EFF}"))
                {
                    return temp;
                }
                temp = temp.Parent;
        ...
        {
            return Sitecore.Context.Database.GetItem("/sitecore/content/home/people");
        }

        public static Item GetLocationsItem()
        {
            return Sitecore.Context.Database.GetItem("{DB6E55B9-AC31-4C3C-8723-0AEA6247C3E3}");
        }

        public static Item GetJobsItem()
        {
            return Sitecore.Context.Database.GetItem("{9B19C94C-5A9C-46C4-97C0-7639036DAF28}");
        }
